...
export const HeroImg = () => {
	...
	return (
		...
		>
			...
			<div className='fog-left-bottom | absolute z-20 -bottom-1/2 -translate-y-[10%] left-1/2 -translate-x-[85%] h-[530px] w-[530px] rounded-[100%] bg-[#3abbd2] bg-opacity-[30%] blur-[150px] tablet:left-[10%] tablet:translate-y-[40%] tablet:scale-150 desktop:-translate-y-[25%] desktop:left-[38%]'></div>
			<div className='fog-top-right | absolute z-20 -top-1/2 translate-y-[10%] right-1/2 translate-x-[85%] h-[530px] w-[530px] rounded-[100%] bg-[#3abbd2] bg-opacity-[30%] blur-[150px] desktop:scale-150 desktop:translate-x-[135%] desktop:translate-y-[20%]'></div>
		</div>
	);
};
