...
export const TournamentBanner = () => {
	return (
		<SectionWrapper>
			<div className='Banner | flex flex-col items-center p-6  relative -skew-x-[1deg] tablet:py-[1.875rem] tablet:px-[5.5rem] desktop:flex-row desktop:px-[2rem] desktopL:px-[4.37rem] desktop:gap-[1.88rem] desktop:py-[3.2625rem] desktop:-skew-x-[3deg]'>
